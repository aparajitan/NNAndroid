...
import com.app_neighbrsnook.adapter.FavoriteListAdapter;
...
public class FavoriteBottomSheetFragment extends BottomSheetDialogFragment {

    FavoriteListAdapter favoriteListAdapter;
    private Context context;
    List<Emojilistdatum> emojilistdata;

    public FavoriteBottomSheetFragment(List<Emojilistdatum> emojilistdata) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        favoriteListAdapter = new FavoriteListAdapter(context, emojilistdata);
