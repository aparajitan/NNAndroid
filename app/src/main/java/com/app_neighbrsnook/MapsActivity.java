...
import com.app_neighbrsnook.databinding.ActivityMapsBinding;
import com.app_neighbrsnook.utils.DirectionsJSONParser;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lat = b.getDouble("lat");
        lon = b.getDouble("lon");
        mOrigin = new LatLng(28.56581749293682, 77.31608696859125);
        ...
        String url = getDirectionsUrl(origin.getPosition(), destination.getPosition(),"driving");
    ...
    private String getDirectionsUrl(LatLng origin, LatLng dest, String directionMode) {
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters + "&key=" + "AIzaSyCNj_z6Ds9bdTLJHbO8WfQOeK_026WR70E";
