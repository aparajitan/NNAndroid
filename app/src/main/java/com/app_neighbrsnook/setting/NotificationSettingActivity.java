...
public class NotificationSettingActivity extends AppCompatActivity {
    ...
    String st_comment_mail, st_dm_phone, st_dm_mail, st_group_phone, st_group_mail, st_business_phone, st_business_mail, st_market_phone, st_market_mail;
    SharedPrefsManager sm;
    CheckBox ch_poll_phone, ch_poll_mail, ch_phone_poll, ch_email_poll, market_phone, market_mail;
    ...
    LinearLayout lnrLayoutGone;
    boolean show = true;
    ImageView downIv, upIv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_notification_setup);
        ...
        downIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                lnrLayoutGone.setVisibility(View.VISIBLE);
        ...
        upIv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                lnrLayoutGone.setVisibility(View.GONE);
        ...
        frm_deactivate_ac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(NotificationSettingActivity.this, DeactivateAccound.class));
            }
        });
        ...
        frm_change_password.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(NotificationSettingActivity.this, ChangePasswordActivity.class);
        ...
        tvFaq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NotificationSettingActivity.this, FaqActivity.class));
            }
        });
        tvAboutUs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NotificationSettingActivity.this, AboutUsActivity.class));
            }
        });
        tvPrivacyPolicy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NotificationSettingActivity.this, TermAndConditionActivity.class));
            }
        });
    }
    ...
    private void findItem() {
        ...
        market_mail = findViewById(R.id.market_mail);
    }

    public void logoutDialog() {
        Dialog dialog = new Dialog(NotificationSettingActivity.this);
        ...
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(NotificationSettingActivity.this, android.R.color.transparent)));
    ...
    private void saveSettingUser() {
        if (UtilityFunction.isNetworkConnected(context)) {
            ...
            if (market_phone.isChecked()) {
                st_market_phone = "1";
                hashMap.put("SendMessageMarketMB", ("1"));
            } else {
                market_phone.setChecked(false);
                st_market_phone = "0";
                hashMap.put("SendMessageMarketMB", ("0"));
            }
            if (market_mail.isChecked()) {
                st_market_mail = "1";
                hashMap.put("SendMessageMarketEmail", ("1"));
            } else {
                market_mail.setChecked(false);
                st_market_mail = "0";
                hashMap.put("SendMessageMarketEmail", ("0"));
            }
        ...
        call.enqueue(new Callback<SettingPojo>() {
            ...
            public void onResponse(Call<SettingPojo> call, Response<SettingPojo> response) {
                ...
                try {
                    ...
                    market_phone.setChecked(!rootObject.getMarketPhone().equals("0"));
                    market_mail.setChecked(!rootObject.getMarketMail().equals("0"));
            ...
            public void onFailure(Call<SettingPojo> call, Throwable t) {
                if (t.toString().contains("timeout")) {
                    Toast.makeText(NotificationSettingActivity.this, "Something seems to have gone wrong.Please try again", Toast.LENGTH_SHORT).show();
                } else if (t.toString().contains("Unable to resolve host")) {
                    Toast.makeText(NotificationSettingActivity.this, "No internet", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(NotificationSettingActivity.this, "Something seems to have gone wrong.Please try again", Toast.LENGTH_SHORT).show();
                }
