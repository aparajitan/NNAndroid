...
public class SettingAccountManagement extends AppCompatActivity {
    ...
    FrameLayout tvAboutUs,tvPrivacyPolicy,tvFaq,frmProfileVisibility;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SettingAccountManagement.this,NotificationSettingActivity.class));
        ...
        frmProfileVisibility.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SettingAccountManagement.this,SettingVisibilityActivity.class));
        ...
        frm_deactivate_ac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(SettingAccountManagement.this,DeactivateAccound.class));
            }
        });
        ...
        frm_change_password.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SettingAccountManagement.this, ChangePasswordActivity.class);
        ...
        tvFaq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SettingAccountManagement.this, FaqActivity.class));
            }
        });
        tvAboutUs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SettingAccountManagement.this, AboutUsActivity.class));
            }
        });
        tvPrivacyPolicy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SettingAccountManagement.this, TermAndConditionActivity.class));
            }
        });
    }

    public void logoutDialog() {
        Dialog dialog = new Dialog(SettingAccountManagement.this);
        ...
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(SettingAccountManagement.this, android.R.color.transparent)));
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                PrefMananger.clearLoginData(context);
              //  PrefMananger.SaveLoginData(getApplicationContext(),null);
                Intent intent = new Intent(SettingAccountManagement.this, LoginActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK); // Clear all activities
                startActivity(intent);
        ...
        call.enqueue(new Callback<SettingPojo>() {
            ...
            public void onFailure(Call<SettingPojo> call, Throwable t) {
                ...
                if (t.toString().contains("timeout")){
                    Toast.makeText(SettingAccountManagement.this, "Something seems to have gone wrong.Please try again", Toast.LENGTH_SHORT).show();


                }else if (t.toString().contains("Unable to resolve host")){
                    Toast.makeText(SettingAccountManagement.this, "No internet", Toast.LENGTH_SHORT).show();
