...
public class OtherUserShowPicture extends AppCompatActivity implements View.OnTouchListener {
    ...
    CircularImageView img_profile_view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_user_show_picture);
    ...
    public class ImagesAdapter extends PagerAdapter {
        ...
        public ImagesAdapter(){
            ...
            layoutInflater = (LayoutInflater) OtherUserShowPicture.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        }
        @Override
        public int getCount() {
            if (getIntent().hasExtra("ImageUpload")){
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            try {
                imageView.setOnTouchListener(new ImageMatrixTouchHandler(OtherUserShowPicture.this));
        ...
        call.enqueue(new Callback<JsonElement>() {
            ...
            public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                ...
                if (jsonObject.get("userpic").getAsString().isEmpty()) {
                    ...
                    img_profile_view.setImageResource(R.drawable.profile);
                } else{
...
//                AppCommon.getInstance(PlaceOrderActivity.this).clearNonTouchableFlags(PlaceOrderActivity.this);
                Toast.makeText(OtherUserShowPicture.this, "Data found", Toast.LENGTH_SHORT).show();
    ...
    private void apiDeleteBusiness(HashMap<String, Object> hm) {
        ...
        call.enqueue(new Callback<JsonElement>() {
            @Override
            public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                Intent i = new Intent(OtherUserShowPicture.this, MyProfile.class);
                startActivity(i);
                // finish();
                finishAffinity();
                Toast.makeText(OtherUserShowPicture.this, "Image deleted Successfully" , Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<JsonElement> call, Throwable t) {
                Toast.makeText(OtherUserShowPicture.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                Log.d("res", t.getMessage());
            }
        });
    }
