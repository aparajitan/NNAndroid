...
//
//
//    public static Reaction wowReact = new Reaction(
//            ReactConstants.DEFAULT,
//            ReactConstants.GRAY,
//            R.drawable.ic_surprise);
//
//    public static Reaction[] reactions = {
//            new Reaction(ReactConstants.LIKE, ReactConstants.BLUE, R.drawable.ic_baseline_favorite_red_24),
...
//    public static Reaction defaultReact = new Reaction(ReactConstants.LIKE, ReactConstants.DEFAULT, ReactConstants.GRAY, R.drawable.ic_gray_like);
//
//    public static Reaction defaultReactWow = new Reaction(ReactConstants.WOW, ReactConstants.YELLOW_WOW, ReactConstants.GRAY, R.drawable.ic_surprise);
