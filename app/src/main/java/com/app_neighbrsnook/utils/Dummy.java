...
public class Dummy {
    ...
    public static List getData() {
        ...
        list.add(new CityEvent("MOM’S Pickles", "Home made food", "Choose from a variety of homemade pickles - mango, amla, green chilli, adrak, garlic etc. 100% preservative & additive free, handcrafted & sundried in small batches by tribal women.","ABC tagline",CityEvent.CITY_TYPE,
