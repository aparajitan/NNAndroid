package com.app_neighbrsnook.libraries.slider;

import static com.app_neighbrsnook.libraries.slider.IndicatorView.draw.controller.AttributeController.getRtlMode;
...
import com.app_neighbrsnook.libraries.slider.IndicatorView.PageIndicatorView;
import com.app_neighbrsnook.libraries.slider.IndicatorView.animation.type.BaseAnimation;
import com.app_neighbrsnook.libraries.slider.IndicatorView.animation.type.ColorAnimation;
import com.app_neighbrsnook.libraries.slider.IndicatorView.animation.type.IndicatorAnimationType;
import com.app_neighbrsnook.libraries.slider.IndicatorView.draw.controller.DrawController;
import com.app_neighbrsnook.libraries.slider.IndicatorView.draw.data.Orientation;
import com.app_neighbrsnook.libraries.slider.IndicatorView.draw.data.RtlMode;
import com.app_neighbrsnook.libraries.slider.IndicatorView.utils.DensityUtils;
import com.app_neighbrsnook.libraries.slider.Transformations.AntiClockSpinTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.Clock_SpinTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.CubeInDepthTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.CubeInRotationTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.CubeInScalingTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.CubeOutDepthTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.CubeOutRotationTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.CubeOutScalingTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.DepthTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.FadeTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.FanTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.FidgetSpinTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.GateTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.HingeTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.HorizontalFlipTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.PopTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.SimpleTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.SpinnerTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.TossTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.VerticalFlipTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.VerticalShutTransformation;
import com.app_neighbrsnook.libraries.slider.Transformations.ZoomOutTransformation;
