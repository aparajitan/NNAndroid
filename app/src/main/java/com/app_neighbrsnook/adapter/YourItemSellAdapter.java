...
public class YourItemSellAdapter extends RecyclerView.Adapter<YourItemSellAdapter.BankViewHolder> {
    ...
    public YourItemSellAdapter(boolean isVerifiedUser, List<YourItemsPojo> listData, Context mcon, SellRequest sellRequest, WallChildAdapter.ImageCallBack icb) {
    ...
    public BankViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new YourItemSellAdapter.BankViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull YourItemSellAdapter.BankViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (marketPlaceTodayListPojo.getPimages().isEmpty()) {
            ...
            Picasso.get().load(marketPlaceTodayListPojo.getPimages()).fit().centerCrop().error(R.drawable.marketplace_white_background).placeholder(R.drawable.marketplace_ppl)
    ...
    public class BankViewHolder extends RecyclerView.ViewHolder {
        TextView view_all_tv, category_name_tv, time_textview;
        RecyclerView rv_today;
        FrameLayout soldFrm;
        TextView item_name, item_price, product_location, nebhourhood_tv, soldTv;
