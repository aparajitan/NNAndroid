...
public class SkipCategoryAdapter extends RecyclerView.Adapter<SkipCategoryAdapter.ViewHolder> {
    Dialog dialog;
    InterestCategoryInterface categoryInterface;
    List<Nbdatum> emailsList = new ArrayList<>();
    public SkipCategoryAdapter(Dialog _dialog, InterestCategoryInterface categoryInterface, List<Nbdatum> emailsList) {
        dialog = _dialog;
        this.categoryInterface =categoryInterface;
        this.emailsList = emailsList;
    }

    public SkipCategoryAdapter(InterestCategoryInterface categoryInterface, List<Nbdatum> emailsList) {
        this.categoryInterface =categoryInterface;
        this.emailsList = emailsList;
    }
    @NonNull
    @Override
    public SkipCategoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.day_list, parent, false);
        return new SkipCategoryAdapter.ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull SkipCategoryAdapter.ViewHolder holder, int position) {
    ...
    public interface InterestCategoryInterface{
        void onClick1(String categoryName, String id);
    }
