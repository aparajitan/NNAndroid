...
public class VideoUploadAdapter extends RecyclerView.Adapter<VideoUploadAdapter.ImageUploadHolder> {
    Activity activity;
    public static ArrayList<ImagePOJO> imageList;
    ImageItemClick itemClick;

    public VideoUploadAdapter(Activity activity, ArrayList<ImagePOJO> bitmapList, ImageItemClick imageItemClick) {
    ...
    public ImageUploadHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(activity).inflate(R.layout.inflate_video_view,viewGroup,false);
    ...
    public class ImageUploadHolder extends RecyclerView.ViewHolder {
        ...
        public ImageUploadHolder(@NonNull View itemView) {
            ...
            img_edit=itemView.findViewById(R.id.edit_personal_information);
