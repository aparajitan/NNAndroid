...
public class AllDataWallShowAdapter extends RecyclerView.Adapter<AllDataWallShowAdapter.BankViewHolder> {
    ...
    private List<AllDataShowPojo> listData;
    ...
    public AllDataWallShowAdapter(boolean isVerifiedUser, List<AllDataShowPojo> listData, Context mcon, SellRequest sellRequest, WallChildAdapter.ImageCallBack icb) {
    ...
    public BankViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AllDataWallShowAdapter.BankViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AllDataWallShowAdapter.BankViewHolder holder, @SuppressLint("RecyclerView") int position) {
        AllDataShowPojo marketPlaceTodayListPojo = listData.get(position);
        ...
        if (marketPlaceTodayListPojo.getpImages() == null || marketPlaceTodayListPojo.getpImages().isEmpty()) {
            ...
            Glide.with(mcon)
                    ...
                    .apply(new RequestOptions().centerCrop().placeholder(R.drawable.marketplace_ppl)
                            .error(R.drawable.marketplace_ppl)).into(holder.porduct_image);
        }
