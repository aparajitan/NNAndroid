...
public class OffersAdapter extends RecyclerView.Adapter<OffersAdapter.ViewHolder> {
    ...
    public OffersAdapter(List<OfferModel> nearbyList, Context mContext, CategoryCallBack ccb) {
    ...
    public OffersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.offer_item_row, parent, false);
        mcon = parent.getContext();
        return new OffersAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OffersAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
