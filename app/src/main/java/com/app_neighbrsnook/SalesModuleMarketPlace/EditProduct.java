    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.video_or_image_upload_rl:
                if (GlobalMethods.checkCameraAndMediaPermission(EditProduct.this)) {
        ...
        VideoCompressor.compressVideo(this, videoUri, new VideoCompressor.CompressionListener() {
            ...
            public void onCompressionSuccess(Uri compressedUri) {
                runOnUiThread(() -> {
                    ...
                    String compressedPath = getPath(EditProduct.this, compressedUri);
                    ...
                    updateVideoTextView();
                    Toast.makeText(EditProduct.this, "Video compressed successfully", Toast.LENGTH_SHORT).show();
                });
            }
            ...
            public void onCompressionFailure(String error) {
                runOnUiThread(() -> {
                    progressDialog.dismiss();
                    Toast.makeText(EditProduct.this, "Video compression failed: " + error, Toast.LENGTH_SHORT).show();
